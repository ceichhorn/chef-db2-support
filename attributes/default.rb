...
default['ruby-deployment']['application']['secret'] = '\'7152545355345150537132565775425269766a51437879326e4e62377551447a7043436753423136427a4d5'\
...
default['ruby-deployment']['application']['env_vars'] =
  [{ 'name' => 'APPLICATION_EMAIL', 'value' => 'jrmoore@gannett.com' },
   { 'name' => 'APPLICATION_SECRET', 'value' => "'#{node['ruby-deployment']['application']['secret']}'" }]
